...
const _firebaseApiKey = String.fromEnvironment('FIREBASE_WEB_API_KEY');
const _firebaseProjectId = 'inkomati-usuthu-isdp';
const _supportContactNumber = 'Contact your administrator';
const _supportContactMessage = 'Contact your administrator.';
...
class IsdpAdminApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'INKOMATI-USUTHU ISDP Admin',
      theme: ThemeData(
  ...
  Future<void> _emailInvoice(Invoice invoice) async {
    ...
    try {
      ...
      await _openOutlookDraftWithAttachment(
        ...
        subject: 'Invoice ${invoice.number} - INKOMATI-USUTHU ISDP',
        body:
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Image.asset(
        ...
        semanticLabel: 'INKOMATI-USUTHU ISDP logo',
      ),
    );
  }
}
...
class _BrandName extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Text.rich(
      TextSpan(
        children: [
          const TextSpan(text: 'INKOMATI-USUTHU '),
          const TextSpan(
            text: 'ISDP',
  ...
  document.addPage(
    pw.MultiPage(
      ...
      footer: (context) => pw.Row(
        ...
        children: [
          pw.Text(
            'INKOMATI-USUTHU ISDP | Support: $_supportContactNumber',
