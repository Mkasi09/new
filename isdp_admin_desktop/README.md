# INKOMATI-USUTHU ISDP Admin Desktop

Separate Flutter desktop project for the INKOMATI-USUTHU ISDP admin console.
...
- Live refresh and 30-second polling of work orders
- Create work orders
