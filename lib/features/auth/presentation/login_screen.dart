  ...
  Future<void> _showPasswordResetSent(String email) {
    return showDialog<void>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'If $email is registered for INKOMATI-USUTHU ISDP, a secure password reset link has been sent. Open the email and follow the link to create a new password.',
        ),
        actions: [
          FilledButton(
