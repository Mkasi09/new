...
- Final Android package and iOS bundle ID are `za.co.inkomatiusuthu.isdp`.
...
- Select the INKOMATI-USUTHU Apple Developer team.
- Enable Push Notifications and Background Modes / Remote notifications.
- Confirm the App Store provisioning profile for `za.co.inkomatiusuthu.isdp`.
